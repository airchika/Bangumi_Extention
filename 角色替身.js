...
(function () {
    ...
    function install_styles() {
        ...
        style.textContent = `
            ...
            html[data-theme=dark] .va-role-lookup-toggle.is-active { background:rgba(255,128,160,.2); color:#ff9ab3; border-color:rgba(255,154,179,.72); box-shadow:inset 0 0 0 1px rgba(255,154,179,.08); }
